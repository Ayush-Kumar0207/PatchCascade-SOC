...
| Factorized MultiDiscrete PPO wastes mass on jointly invalid node/CVE pairs | Learning may be unnecessarily handicapped | A pinned flattened Discrete + MaskablePPO candidate has exact mapping/mask tests and is a preregistered validation-only ablation; no superiority is claimed and held-out seeds remain sealed |
