...
| Reset, event timing, set iteration, and termination semantics drifted | Same seed or Gym trajectory could differ | Explicit seeding, sorted choices, aligned timing, and terminated/truncated regression tests |
